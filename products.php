...
<tr>
    ...
    <table width="41%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td width="80%" align="left"> <font size="12px">M</font><span style="font-size: 18px;">etzonali</td>
	    </tr>
	  </table></td>
...
<table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" id="btnadd" value="+ Agregar Insumo" /></a>
        </td>
      </tr>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
     ...
     <tr>
     <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #033; background: #033; color:#FFF;"> Tabla - Informacion de Insumos	</th>
    </tr>
